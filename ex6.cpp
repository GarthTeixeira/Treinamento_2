...
std::map<char,GLfloat[3]> first;

GLfloat cameraPositions[][3] = {
    {10.0, 6.0, 9.0}, // Vista frontal
    {10.0, 6.0, -3.0}, // Vista traseira
    {16.0, 6.0, 3.0}, // Vista direita
    {4.0, 6.0, 3.0}, // Vista esquerda
    {10.0,0.0,3.0}, //Vista de baixo
    {10.0,12.0,3.0}

};

GLfloat posicaoAtual[3] = {10.0, 6.0, 9.0};

GLfloat horientacaoZ[3] = {0.0,0.0,1.0};

GLfloat horientacaoY[3] = {0.0,1.0,0.0};

GLfloat horientacaoX[3] = {-1.0,0.0,0.0};
